    ...
    public function import(Request $request)
    {
        ...
        for ($i = 1; $i < $count; $i++) {
            ...
            $sql = [
                ...
                'money' => $msg['ruleId'] != null && $msg['staffSn'] != null && $msg['violateAt'] != null ? $this->produceMoneyService->generate($oaData, $msg, 'money')['data'] : null,
                'score' => $msg['ruleId'] != null && $msg['staffSn'] != null && $msg['violateAt'] != null ? $this->produceMoneyService->generate($oaData, $msg, 'score')['data'] : null,
                'violate_at' => $res[$i][4],
